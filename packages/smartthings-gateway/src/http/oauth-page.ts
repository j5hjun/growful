...
const sharedStyles = `
    :root {
      ...
      --action-hover: #353b43; --focus: #2563eb; --error: #b42318;
      --shadow-panel: #1f29370a; --font-h1: 1.75rem; --font-body: 1rem;
      --font-small: .875rem; --weight-bold: 700; --line-heading: 1.25; --line-body: 1.6;
      --line-action: 1.25; --tracking-h1: -.02em;
      --panel-max: 34rem; --control-size: 1.125rem; --control-offset: .15rem;
    ...
    * { box-sizing: border-box; }
    body { margin: 0; min-height: 100dvh; display: grid; place-items: center; padding: var(--space-4); background: var(--canvas); color: var(--text); font-size: var(--font-body); }
    main { width: min(var(--panel-max), 100%); padding: var(--space-8); border-radius: var(--radius-panel); background: var(--surface); box-shadow: 0 var(--space-2) var(--space-8) var(--shadow-panel); }
    ...
    h1, h2, p, label, button { word-break: keep-all; overflow-wrap: break-word; }
