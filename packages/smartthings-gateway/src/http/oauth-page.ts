...
const sharedStyles = `
    ...
    * { box-sizing: border-box; }
    ...
    main { width: min(var(--page-max), 100%); padding: var(--space-8); border-radius: var(--radius-panel); background: var(--surface); box-shadow: 0 var(--space-2) var(--space-8) var(--shadow-panel); }
