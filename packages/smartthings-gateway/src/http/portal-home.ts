...
export function renderPortalHome(): string {
  return renderGatewayPage({
    ...
    description:
      "SmartThings OAuth 토큰을 대신 보관하고 Growful 토큰으로 안전하게 연결하는 비공개 베타 Gateway입니다.",
    layout: "wide",
    robots: "index,follow",
    ...
    @media (max-width: 48rem) {
      ...
      .flow ol, .trust-boundary { grid-template-columns: 1fr; }
      .flow ol, .trust-boundary { gap: var(--space-4); }
    }`,
