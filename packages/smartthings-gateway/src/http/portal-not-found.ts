...
export function renderPortalNotFound(access: OAuthAccessPolicy): string {
  return renderGatewayPage({
    ...
    .not-found-document { max-width: var(--panel-manage); }
    ...
    .support-safety { margin-top: var(--space-4); padding: var(--card-padding); border-radius: var(--radius-field); background: var(--surface-subtle); font-size: var(--font-small); }
