...
If neither `REMINDER_MCP_SEND_COMMAND` nor `REMINDER_MCP_ALLOW_OUTBOX_FALLBACK=1` is set, reminders can be created and listed, but due reminder delivery fails with a setup message.
